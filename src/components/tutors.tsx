    ...
    <div className="mx-auto flex max-w-(--breakpoint-xl) flex-col justify-center gap-16 px-6 py-8 sm:py-16 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-6 text-base text-muted-foreground sm:text-xl">
          Our tutors are industry experts with a passion for teaching. They have
          a wealth of experience in their respective fields and are dedicated to
          helping you succeed.
        </p>
          ...
          >
            ...
            <div className="mt-auto flex items-center gap-4">
              <Link href="#" target="_blank">
                <SiX className="h-5 w-5 stroke-muted-foreground" />
              </Link>
              <Link href="#" target="_blank">
                <SiDribbble className="h-5 w-5 stroke-muted-foreground" />
              </Link>
              <Link href="#" target="_blank">
                <SiTwitch className="h-5 w-5 stroke-muted-foreground" />
              </Link>
            </div>
          </div>
        ))}
